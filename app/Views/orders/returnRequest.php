...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
                ...
                <div class="modal fade" id="modal-default1" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="updateReturnedForm">
                                <input type="hidden" id="return_request_id" name="return_request_id">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="status">Status</label><br>
                                                <select class="form-control" id="update_returned_status" name="update_returned_status">
                                                    <option value="">Update Status</option>
                                                    <option value="5">Returned Successfully (amount will be refunded to wallet)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="<?= base_url('/assets/page-script/return_request.js') ?>"></script>
