            ...
            <ul class="w-full max-w-lg mx-auto my-12 pt-2 pb-5 px-4 flex items-center justify-center">
                ...
                <li class="w-full flex  after:w-full after:h-1 last:after:hidden last:w-fit after:bg-gray-200">
                    <a href="/checkout" class="flex flex-col items-center gap-4 -mt-[13px] relative"><span
                            ...
                            class="text-secondary text-sm font-medium capitalize absolute -bottom-8"><?php echo lang('website.checkout'); ?></small></a>
                </li>
                <li class="w-full flex  after:w-full after:h-1 last:after:hidden last:w-fit after:bg-gray-200">
                    <a href="#" class="flex flex-col items-center gap-4 -mt-[13px] relative"><span
                            class="w-[30px] h-[30px] border-[4px] rounded-2xl border-[#D9DBE9] bg-[#D9DBE9]"></span><small
                            class="text-secondary text-sm font-medium capitalize absolute -bottom-8"><?php echo lang('website.order'); ?></small></a>
                </li>
            </ul>
                        ...
                        <div class="card-body flex flex-col gap-4">
                            ...
                            <div class="relative flex flex-col min-w-0 rounded-lg break-words bg-white">
                                ...
                                <ul class="flex flex-col">
                                    ...
                                    <li class="relative py-2 -mb-px  no-underline flex justify-between items-start">
                                        <div>
                                            <div><?php echo lang('website.discount'); ?></div>
                                        </div>
                                        <div>
                                            <?php if ($settings['currency_symbol_position'] == 'left'): ?>
                                    ...
                                    <li class="relative py-2 border-t -mb-px no-underline flex justify-between items-start">
                                        <div>
                                            <div class="font-bold text-gray-800"><?php echo lang('website.grand_total'); ?></div>
                                        </div>
                                        <div>
                                            <?php if ($settings['currency_symbol_position'] == 'left'): ?>
                                                <?= $country['currency_symbol'] ?><span class="font-bold text-gray-800 grand_total">0</span>
                                            <?php else: ?>
                                                <span class="font-bold text-gray-800 grand_total">0</span><?= $country['currency_symbol'] ?>
                                            <?php endif; ?>
                                        </div>
