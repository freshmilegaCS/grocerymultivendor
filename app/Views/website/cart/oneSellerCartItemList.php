                                                ...
                                                <?php if ($productDetail['discounted_price'] > 0 && $productDetail['discounted_price'] < $productDetail['price']): ?>
                                                    <span class="font-bold text-gray-800">
                                                        <?php if ($settings['currency_symbol_position'] == 'left'): ?>
                                                            <?= $country['currency_symbol'] ?><?= round($productDetail['discounted_price'], 2) ?>
                                                        <?php else: ?>
                                                            <?= round($productDetail['discounted_price'], 2) ?><?= $country['currency_symbol'] ?>
                                                        <?php endif; ?>
                                                    </span>
                                                    <div class="line-through text-gray-500 text-sm self-end">
                                                        <?php if ($settings['currency_symbol_position'] == 'left'): ?>
                                                            <?= $country['currency_symbol'] ?><?= round($productDetail['price'], 2) ?>
                                                        <?php else: ?>
                                                            <?= round($productDetail['price'], 2) ?><?= $country['currency_symbol'] ?>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php else: ?>
                                                    <span class="font-bold text-gray-800">
