    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Header Category</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-<?php echo $settings['primary_color']; ?>">
                <div class="card-header">
                  <h3 class="card-title">Add Header Category</h3>
                </div>
                <!-- /.card-header -->
                <form method="post" id="HeaderCategoryForm" enctype="multipart/form-data">
                  <div class="card-body">

                    <div class="form-group">
                      <label for="header_category_title">Header Category Name</label>
                      <input type="text" class="form-control " name="header_category_title" id="header_category_title" placeholder="Enter Category Name">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select form-control" id="icon_library" name="icon_library">
                        <option value="">Select Icon Library</option>
                            ...
                            <option value="3">  Ionicons </option>
                            <option value="4">  MaterialIcons </option>
                      </select>
                    </div>

                    <div class="form-group">
                      <label for="header_category_icon">Header Category Icon <span class="text-danger text-sm">Enter correct icon name from selected library —wrong names may crash the app.</span></label> Find Icon from <a href="https://oblador.github.io/react-native-vector-icons/" class="text-danger " target="_blank"> Here</a>
                      <input type="text" class="form-control " name="header_category_icon" id="header_category_icon" placeholder="Enter Category Icon">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="card-footer">
                    <button type="button" name="add_cat" id="add_cat" class="btn btn-primary" onclick="addHeaderCategory()">
                      Add Header Category
                    </button>
                  </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">View Header Category</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <table id="view_header_category" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Header Category Name</th>
                        <th>Icon Details</th>
