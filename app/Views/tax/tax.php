                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " name="tax" id="tax" placeholder="Enter Tax Title">
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="button" name="add_cat" id="add_cat" class="btn btn-primary" onclick="addTax()">
                                            Add Tax
                                        </button>
                                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="view_taxes" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>Sr No</th>
                                                <th>Tax Name</th>
