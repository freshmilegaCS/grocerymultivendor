...
<head>
    ...
    <title>Seller List | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>

    <?= $this->include('template/style') ?>

</head>

<body class=" sidebar-mini sidebar-collapse text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm " id="body">
    <div class="wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">View Seller List</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
    ...
    <script src="<?= base_url('/assets/page-script/seller_list.js') ?>"></script>
</body>
