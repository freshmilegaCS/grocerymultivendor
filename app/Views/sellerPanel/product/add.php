...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
                                ...
                                <div class="card card-<?php echo $settings['primary_color']; ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="total_allowed_quantity">Total allowed quantity <span class="text-danger">Keep blank if no such limit</span></label>
                                                    <input type="number" class="form-control " name="total_allowed_quantity" id="total_allowed_quantity" placeholder="Enter Total allowed quantit">
                                                </div>
                                            </div>
    ...
    <script src="<?= base_url('/assets/page-script/sellerPanel/product_add.js') ?>"></script>
    <script>
