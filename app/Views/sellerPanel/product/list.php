...
<head>
    ...
    <title>Product List | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>

    <?= $this->include('sellerPanel/template/style') ?>

</head>

<body class=" text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm sidebar-collapse" id="body">
    <div class="wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">View Product List</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
    ...
    <script src="<?= base_url('/assets/page-script/sellerPanel/product_list.js') ?>"></script>
