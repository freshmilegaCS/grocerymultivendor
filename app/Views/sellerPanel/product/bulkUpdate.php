...
3. Create/ Edit .csv file for product as explain below:
        ...
        Note - Do not set empty field in variants. if you have no value on specific column then add "0"(zero) in that column.</pre>
                                    ...
                                    <div class="row">
                                        <form method="post" action="/seller/product/bulk-update/update" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <a href="<?= base_url() ?>/seller/product/bulk-update/download" download="update-products.csv" class="btn btn-warning"><em class="fa fa-download"></em>
