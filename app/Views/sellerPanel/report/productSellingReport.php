...
<head>
    ...
    <title>Product Selling Report | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Product Selling Report</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Product Selling Report</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            <div class="card card-<?= $settings['primary_color'] ?>">
                                <div class="card-header">
                                    <h3 class="card-title">View Product Selling Report</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            <form action="">
                                                <div class="mr-2">
                                                    ...
                                                    <div class="input-group primary-bprder">
                                                        ...
                                                        <input type="text" class="form-control  primary-bprder  filter-product" id="report_date">
                                ...
                                <table id="view_selling_report" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>Product Name</th>
                                            <th>Variant Info</th>
    ...
    <script src="<?= base_url('/assets/page-script/sellerPanel/product_selling_report.js') ?>"></script>
