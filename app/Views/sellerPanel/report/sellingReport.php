...
<head>
    ...
    <title>Sales Report | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-<?= $settings['primary_color'] ?>">
                                ...
                                <table id="view_product_selling_report" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>Order Id</th>
                                            <th>Order Item Id</th>
    ...
    <script src="<?= base_url('/assets/page-script/sellerPanel/selling_report.js') ?>"></script>
