...
<head>
    ...
    <title>Delivery Boy List | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">View Delivery Boy List</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
    ...
    <script src="<?= base_url('/assets/page-script/delivery_boy.js') ?>"></script>
