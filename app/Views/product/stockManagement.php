...
<head>
    ...
    <title>Stock Management | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
...
<body class=" text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm " id="body">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">View Stock Management</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                <div class=" d-flex justify-content-between">
                                        <div class="d-flex  ">
                                            ...
                                            <div class="mx-2">
                                                ...
                                                <select id="status" class=" form-control form-control-sm primary-bprder filter-product">
                                            ...
                                            <div class="mx-2">
                                                ...
                                                <select id="stock" class="form-control form-control-sm primary-bprder filter-product">
                                                    <option value="" <?php echo isset($_GET['stock']) ? 'selected ' : '' ?>>All Products</option>
                                                    <option value="0" <?php echo  isset($_GET['stock']) && $_GET['stock'] == 0 ? 'selected' : '' ?>>Sold out </option>
                                                    <option value="1" <?php echo  isset($_GET['stock']) && $_GET['stock'] == 1 ? 'selected' : '' ?>>Available </option>
                                                    <option value="2" <?php echo  isset($_GET['stock']) && $_GET['stock'] == 2 ? 'selected' : '' ?>>Low on Stock </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <table id="view_product" class="table table-bordered ">
                                        <thead>
                                            <tr>
                                                <th>Variation Id</th>
                                                <th>Name</th>
    ...
    <script src="<?= base_url('/assets/page-script/product_stock_management.js') ?>"></script>
