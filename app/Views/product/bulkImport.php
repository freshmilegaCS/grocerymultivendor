...
3. Create/ Edit .csv file for product as explain below:
        ...
        Note - Do not set empty field. if you have no value on specific column then add "0"(zero) in that column.</pre>
                                    ...
                                    <div class="row">
                                        <form method="post" action="/admin/product/bulk-import/insert" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <a href="<?= base_url() ?>sample-file/import-products.csv" download="import-products.csv" class="btn btn-warning"><em class="fi fi-tr-file-download"></em>
