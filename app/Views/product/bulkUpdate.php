...
<head>
    ...
    <title>Bulk Update Product | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
                            ...
                            <div class="card card-<?php echo $settings['primary_color']; ?>">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-default-danger">
                                        ...
                                        <h5>Always take a backup of Database mysql before proceeding, so if soemthing went wrong while updating you can roll out allways.</h5>
...
3. Create/ Edit .csv file for product as explain below:
        ...
        Product ID * -&gt; Dont edit it in downloaded file
        Product Name * -&gt; Name of the product. 
        Brand ID * -&gt; Brand ID of the product (You can find Brand ID in Categories section).
        Seller ID * -&gt; Seller ID of the product (You can find Seller ID in Categories section).
        ...
        -&gt; for example, If you want to update variants then you will see below columns. Product must have 1 variant.

            Product variant ID * -&gt; Dont edit it in downloaded file
        ...
        Note - Do not set empty field in variants. if you have no value on specific column then add "0"(zero) in that column.</pre>
                                    </div>
                                    <div class="row">
                                        <form method="post" action="/admin/product/bulk-update/update" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <a href="<?= base_url() ?>admin/product/bulk-update/download" download="update-products.csv" class="btn btn-warning"><i class="fi fi-tr-file-download"></i>
                                                    Download Data CSV File</a>
                                                <button type="submit" id="submit_btn" class="btn btn-primary"><i class="fi fi-tr-cloud-upload-alt"></i> Upload
                                                </button>
                                                <button type="reset" class="btn btn btn-secondary"><i class="fi fi-tr-undo-alt"></i> Clear
                                                </button>
