...
class StockMangement extends BaseController
{
    public function index()
    {
        ...
        if ($session->has('user_id') && session('account_type') == 'Admin') {
            ...
            return view('product/stockManagement', [
    ...
    public function update()
    {
        ...
        if ($productVariantModel->where('id', $productVariantId)->set($data)->update()) {
            $output['success'] = true;
